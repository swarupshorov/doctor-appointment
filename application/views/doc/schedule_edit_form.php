		...
		<div class="row-fluid">
			<div class="span12">
				...
				<?php echo  form_open('Chamber/SaveEditData', 'class="form-horizontal" id=""');?>
					...
					<div class="control-group">
						<label class="control-label" for="phone">Phone: <i class="icon-asterisk" style="color: #d14747"></i></label>
						<div class="controls">
					...
					<div class="hr"></div>
					<input type="hidden" name="id" id="id" value="<?php echo set_value('id', $allData->id); ?>"  />
