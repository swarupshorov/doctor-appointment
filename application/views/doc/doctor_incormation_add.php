		...
		<div class="row-fluid">
			<div class="span12">
				<!--PAGE CONTENT BEGINS-->
				<?php echo  form_open('Doctor/saveInformation', 'class="form-horizontal" id=""');?>
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo form_dropdown('special_id',$specility_list,$allData['special_id'],array('class'=>'chzn-select','id'=>'form-field-select-3'));?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="form-field-1" placeholder="Cell No" name="cell_no" value="" required/>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label " for="place">Address: <i class="icon-asterisk" style="color: #d14747"></i></label>
						<div class="controls ">
							<textarea  placeholder="Address" name="address"  id="place" required></textarea>
						</div>
					</div>
					...
					<div class="control-group ">
			            ...
			            <div class="controls ">
			                <div class="row-fluid input-append">
			                    <input class="date-picker" id="id-date-picker-1 date" type="text" name="date_of_birth" data-date-format="yyyy-mm-dd" />
			                    <span class="add-on">
			        ...
			        <div class="control-group">
						<label class="control-label" for="form-field-1">Education: <i class="icon-asterisk" style="color: #d14747"></i></label>
						<div class="controls education-f-add">
							<input type="text" placeholder="Education" name="education[]" value="" required/>
						</div>
